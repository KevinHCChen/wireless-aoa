...
class regularizedAdam(optimizer.GradientMethod):
    ...
    """
    def __init__(self, alpha=0.001, beta1=0.9, beta2=0.999, eps=1e-8, _lambda = 0.1):
    ...
    def update_one_cpu(self, param, state):
        ...
        # grad = param.grad 
        # new gradient that 
        grad = param.grad + self._lambda*param.data
